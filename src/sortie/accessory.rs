...
pub fn item_menu_item_x_call(this: &mut BasicMenuItem, _method_info: OptionalMethod) -> i32 {
    unit_accessory_sub_menu_create_bind(this);
    return 0x80;
}
...
pub fn create_basic_menu_content(method_info: OptionalMethod) -> &'static BasicMenuContent; 
